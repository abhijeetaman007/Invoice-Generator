...
const InvoiceTemplate = (props) => {
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(12);
    doc.text('My Company Name', 60, 25);
    doc.text('123 Main St', 60, 32);
    doc.text('Anytown, USA 12345', 60, 39);
    ...
    doc.text('John Doe', 15, 77);
    doc.text('1234 Any St', 15, 84);
    doc.text('Anytown, USA 12345', 15, 91);
    ...
    doc.setFontSize(12);
    doc.setTextColor(0);
    doc.text('Item', 20, 116);
    doc.text('Description', 60, 116);
    ...
    doc.setFontSize(10);
    doc.text('1', 20, 125);
    doc.text('Item 1', 60, 125);
    doc.text('2', 120, 125);
    doc.text('$10.00', 160, 125);
    doc.text('2', 20, 132);
    ...
    doc.text('$25.00', 160, 167);
    doc.text('Tax:', 120, 174);
    doc.text('$2.50', 160, 174);
    doc.text('Total:', 120, 181);
    doc.text('$27.50', 160, 181);
